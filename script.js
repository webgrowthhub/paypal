...
const get_client_token = () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await fetch("http://localhost/get_client_token", {
...
const client_id = "AZ0Gq-GRXpdTylF2Uqctix_7wtPRI4C_z75jqs1-oFmVswzsu5fTpMFuZQMWKe7NqEG-pM5mp9Ioa2E6";
const currency = "AUD";
...
.then(() => {
    ...
    let paypal_buttons = paypal.Buttons({ // https://developer.paypal.com/sdk/js/reference
        ...
        createOrder: function(data, actions) { //https://developer.paypal.com/docs/api/orders/v2/#orders_create
            return fetch("http://localhost/create_order", {
        ...
        onApprove: function(data, actions) {
          console.log(data);
            ...
            console.log(data);
            return fetch("http://localhost/complete_order", {
                method: "post", headers: { "Content-Type": "application/json; charset=utf-8" },
                body: JSON.stringify({
                    "intent": intent,
                    "order_id": order_id
